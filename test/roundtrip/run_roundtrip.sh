...
declare -A EXPECTED_RESULT=(
    ...
    [test_sliding_window_max]=0x00061D01
    [test_count_distinct_window]=0x00050F03
    [test_gcd_array]=0x00040648
    [test_primorial]=0x0005FECE
    [test_gray_code]=0x00080304
    [test_fisher_yates]=0x00082408
    [test_partition_equal_sum]=0x00031C01
    [test_jump_game2]=0x00030703
    [test_perfect_squares]=0x00040A04
    ...
    [test_max_xor_pair]=0x00061C1B
    [test_rotate_image]=0x00030F07
    [test_meeting_rooms]=0x0003011E
    [test_decode_ways]=0x00080301
    [test_two_sum_pairs]=0x00030A04
    [test_task_scheduler]=0x00090903
    [test_consecutive_seq]=0x00020409
    [test_dice_combinations]=0x00020F06
    [test_max_points_line]=0x00060306
...
TESTS=(hello test_sorting test_math test_state_machine test_crypto \
       ...
       test_sliding_window_max test_count_distinct_window \
       test_gcd_array test_primorial \
       ...
       test_max_xor_pair test_rotate_image \
       test_meeting_rooms test_decode_ways \
